...
class WallServiceTest {
    ...
    fun postExisting() {
        ...
        val add = service.addPost(Post(0,111,123,12312,123123,videoAdd))
    ...
    fun updateExistingTrue(){
        ...
        service.addPost(Post(0,111,123,12312,123123,null))
        service.addPost(Post(0,1,112,558,88888,null))
        service.addPost(Post(0,5551,515,879,797979,null))
